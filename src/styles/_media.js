...
// Okay this was a fun function! Explanation: now all we have to do is import this badboy and do ${media.sizes} and provide responsive values to whatever and we're good to go!
